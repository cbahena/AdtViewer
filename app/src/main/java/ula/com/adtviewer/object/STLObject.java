package ula.com.adtviewer.object;
...
/* Clase para procesar el modelo 3D
 * @author kshoji
...
public class STLObject {
    ...
    /**
     * Metodo para cargar los parametros de la ventana de carga de archivo
     * @param context
	...
	/**
	 * Metodo processSTL FIXME 'STL format error detection' depends exceptions.
	 * @param stlBytes
	 * @param context
	 * @return boolean*/
